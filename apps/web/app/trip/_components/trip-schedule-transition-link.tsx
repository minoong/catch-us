    ...
    <>
      <InteractiveHoverButton
        className={cn(
          ...
          size === "compact" &&
            "px-2 py-0 text-xs [&>div:first-child]:gap-1.5 [&>div:first-child>div]:size-1.5 [&>div:first-child>span]:whitespace-nowrap [&>div:last-child]:gap-1 [&>div:last-child>span]:whitespace-nowrap [&>div:last-child>svg]:size-3.5",
          variant === "dark" &&
