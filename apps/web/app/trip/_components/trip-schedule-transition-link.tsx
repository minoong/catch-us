  ...
  return (
    <>
      <InteractiveHoverButton
        className={cn(
          "h-full w-full border-0 font-black",
          "data-[force-hover=true]:scale-[0.96] data-[force-hover=true]:ring-4 data-[force-hover=true]:ring-red-400/40",
          "group-active:[&>div:first-child>div]:scale-[100.8] group-active:[&>div:first-child>span]:translate-x-12 group-active:[&>div:first-child>span]:opacity-0 group-active:[&>div:last-child]:opacity-100",
          size === "default" &&
            "px-4 py-0 text-sm group-active:[&>div:last-child]:-translate-x-5",
          size === "compact" &&
            "px-2 py-0 text-xs [&>div:first-child]:gap-1.5 [&>div:first-child>div]:size-1.5 [&>div:first-child>span]:whitespace-nowrap [&>div:last-child]:gap-1 group-hover:[&>div:last-child]:!translate-x-0 group-active:[&>div:last-child]:!translate-x-0 group-data-[force-hover=true]:[&>div:last-child]:!translate-x-0 [&>div:last-child>span]:whitespace-nowrap [&>div:last-child>svg]:size-3.5",
          variant === "dark" &&
