...
import { TravelDottedMap } from "./travel-dotted-map";
  ...
  return (
    <main className="bg-background text-foreground min-h-screen overflow-hidden">
      <section className="relative isolate flex min-h-screen items-center px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div className="mx-auto flex w-full max-w-7xl flex-col gap-10 pt-16 sm:pt-20 lg:pt-0">
          <TravelDottedMap />
            ...
            <div className="flex flex-col gap-7">
              ...
              >
                ...
                <p className="text-muted-foreground max-w-2xl text-base leading-7 sm:text-lg">
                  Catch Us는 너와 여자친구의 일상 사진을 위치, 날짜, 키워드,
                  인물 단서로 정리해서 나중에 “그날 거기”를 자연스럽게 다시 찾게
                  해주는 개인 사진 서비스입니다.
                </p>
              </motion.div>
